...
import in.mused.api.domain.UserIntegrationTest;
...
privileged aspect UserIntegrationTest_Roo_IntegrationTest {
    ...
    @Autowired
    SecurityService UserIntegrationTest.securityService;
    ...
    public void UserIntegrationTest.testCountAllUsers() {
        ...
        long count = securityService.countAllUsers();
    ...
    public void UserIntegrationTest.testFindUser() {
        ...
        obj = securityService.findUser(id);
    ...
    public void UserIntegrationTest.testFindAllUsers() {
        ...
        List<User> result = securityService.findAllUsers();
    ...
    public void UserIntegrationTest.testFindUserEntries() {
        ...
        List<User> result = securityService.findUserEntries(firstResult, maxResults);
    ...
    public void UserIntegrationTest.testDeleteUser() {
        ...
        Assert.assertNotNull("Data on demand for 'User' failed to provide an identifier", id);
        obj = securityService.findUser(id);
        securityService.deleteUser(obj);
        Assert.assertNull("Failed to remove 'User' with identifier '" + id + "'", securityService.findUser(id));
    }
