...
import in.mused.api.web.UserController;
...
privileged aspect UserController_Roo_Controller {
    ...
    public String UserController.show(@PathVariable("id") ObjectId id, Model uiModel) {
        addDateTimeFormatPatterns(uiModel);
        uiModel.addAttribute("user", securityService.findUser(id));
    ...
    public String UserController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        if (page != null || size != null) {
            ...
            uiModel.addAttribute("users", securityService.findUserEntries(firstResult, sizeNo));
            float nrOfPages = (float) securityService.countAllUsers() / sizeNo;
    ...
    public String UserController.updateForm(@PathVariable("id") ObjectId id, Model uiModel) {
        populateEditForm(uiModel, securityService.findUser(id));
        return "users/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String UserController.delete(@PathVariable("id") ObjectId id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    void UserController.addDateTimeFormatPatterns(Model uiModel) {
        ...
        uiModel.addAttribute("user_lastupdated_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
