...
class SocialConnectionRepository implements ConnectionRepository {
	...
	Logger log = LogManager.getLogger(SocialConnectionRepository.class);

	//private final TextEncryptor textEncryptor;

	public SocialConnectionRepository(String userId, 
