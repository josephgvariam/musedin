...
module.exports = function(grunt) {
    ...
    this.files.forEach(function(file) {
      ...
      if (destType === 'file') {
        if (srcFiles.length === 1) {
          ...
          grunt.file.copy(srcFile, changeDestFileExtension(file.dest), copyOptions);
        ...
        srcFiles.forEach(function(srcFile) {
          ...
          grunt.file.copy(srcFile, changeDestFileExtension(destFile), copyOptions);
        });
  ...
  var changeDestFileExtension = function(dest) {
    if (grunt.util._.endsWith(dest, '.html')){
      return dest.substr(0, dest.lastIndexOf(".")) + ".jsp";
    } else {
      return dest;
    }
  };
