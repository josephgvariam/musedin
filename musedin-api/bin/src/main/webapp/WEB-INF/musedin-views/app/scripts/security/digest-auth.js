...
$.Class("MusedIn.DigestAuthentication", {
	MAX_ATTEMPTS : 1,
	...
	invokeCall: function(uri,authorizationHeader){
		...
		$.ajax({
		        ...
		        error: function(response) { 
		        	...
		        	var paramParser = new MusedIn.HeaderParamsParser(response.getResponseHeader(digestAuth.WWW_AUTHENTICATE_HEADER));
...
$.Class("MusedIn.HeaderParamsParser",{
